...
def data_get():
    city=city_name.get()
    data=requests.get("https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=a78f74224464d91b54e8399419f6253d").json()
...
wb_label =Label(win,text="weather desciption",font=("Time New Roman",17))
